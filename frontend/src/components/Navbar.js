        ...
        <div className="bg-black p-4 items-center">
            <nav className="">
                ...
                <div className="float-right pr-1 divide-x divide-green-400 divide-opacity-75 hidden lg:block">
                    { userAuth ? 
                        <Fragment>
                            <a className="text-gray-200 px-4 font-semibold text-lg">Welcome, {userData.first}</a>
                ...
                <div className={mobileMenuHidden ? "hidden" : "lg:hidden"}>
                    { userAuth ? 
                        <Fragment>
                            <a className="text-gray-200 px-4 py-2 block font-semibold text-lg">Welcome, {userData.first}</a>
