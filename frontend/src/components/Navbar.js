...
function Navbar() {
    ...
    return (
        <div className="bg-black sm:bg-red-400 md:bg-yellow-300 lg:bg-yellow-700 xl:bg-indigo-300 2xl:bg-blue-900 p-4 items-center">
            <nav className="">
                ...
                <div className="lg:hidden float-right text-2xl">
                    <button className="items-center" onClick={toggleMobileMenu}><i class="fas fa-bars text-white h-8 w-8"></i></button>
                </div>
                <div className={mobileMenuHidden ? "hidden" : "lg:hidden"}>
                    <Link className="px-4 py-2 text-yellow-300 font-semibold uppercase hover:text-gray-200 tracking-wider text-lg block" to="/" onClick={toggleMobileMenu}>Log In</Link>
